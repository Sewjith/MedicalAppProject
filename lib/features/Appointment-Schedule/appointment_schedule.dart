...
import 'package:medical_app/features/Appointment-Schedule/appointment_confirmation.dart';
import 'package:medical_app/features/Appointment-Schedule/appointment_database.dart';
...
class _AppointmentSchedulePageState extends State<AppointmentSchedulePage> {
  ...
  final List<String> availableTimes = [
    ...
    "11:15 AM","11:30 AM","11:45 AM","12:00 PM","12:15 PM","12:30 PM","12:45 PM","1:00 PM","1:15 PM","1:30 PM",
    "1:45 PM","2:00 PM","2:15 PM","2:30 PM","2:45 PM","3:00 PM","3:15 PM","3:30 PM","3:45 PM","4:00 PM",
  ];

  // List of doctors and their categories
  final List<Map<String, String>> doctors = [
    {"name": "Dr. John Doe", "category": "Dermatologist"},
    {"name": "Dr. Maria Gomez", "category": "Pediatrician"},
    {"name": "Dr. Alice Smith", "category": "Cardiologist"},
  ];
  ...
  final DatabaseService _dbService = DatabaseService(); // Create instance
  ...
  void _confirmAppointment() async {
    ...
    bool success = await _dbService.bookAppointment(
        ...
        problemDesc: _problemController.text.isEmpty
            ? "No description"
