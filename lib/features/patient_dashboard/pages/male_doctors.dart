...
class MaleDoctor extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: MaleDoctorScreen(),
...
class _MaleDoctorScreenState extends State<MaleDoctorScreen> with SingleTickerProviderStateMixin {
