...
class LabResultPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Lab Results', style: TextStyle(color: Colors.white)),
  ...
  Widget _buildReportList(BuildContext context) {
    ...
    List<Map<String, String>> reports = List.generate(20, (index) {
      return {
        'title': 'Blood Test Results $index',
        'subtitle': 'Category: Hematology\nAdded: Feb 10, 2024',
      };
    });
          ...
          child: Card(
            ...
            child: ListTile(
              ...
              leading: CircleAvatar(
                radius: 35,
                backgroundColor: Colors.white,
                child: const Icon(Icons.note, size: 35, color: Colors.black54),
              ),
              title: Text(
                reports[index]['title']!,
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text('Do you want to delete this lab result?'),
          actions: [
            TextButton(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text('Category: Hematology'),
            SizedBox(height: 8),
            Text('Added Date: Feb 10, 2024'),
            SizedBox(height: 8),
            Text('Last Modified Date: Feb 11, 2024'),
          ],
        ),
      ),
    );
