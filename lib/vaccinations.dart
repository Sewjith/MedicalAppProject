...
class VaccinationsPage extends StatelessWidget {
        ...
        return Padding(
          ...
          child: Card(
            ...
            child: ListTile(
              ...
              subtitle:
                  const Text('Category: Immunization\nAdded: Jan 30, 2024'),
              trailing: Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      _showVaccinationDetails(context);
                    },
                  ),
                ],
              ),
  ...
  void _showVaccinationDetails(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
          ...
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: const [
              Text('Title: Flu Vaccine'),
              Text('Description: Annual flu vaccination to prevent influenza.'),
